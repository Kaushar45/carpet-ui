...
const Footer = () => {
  ...
  return (
    <footer
      ref={containerRef}
      className="relative overflow-hidden bg-teal-950 text-emerald-100/70 border-t mt-20 border-teal-600 shadow-[0_-10px_30px_rgba(0,0,0,0.8)] pb-12 rounded-t-[40px] border-l border-r border-black"
    >
        ...
        >
          {[...Array(12)].map((_, i) => (
            <div key={i} className="flex items-center mx-6 gap-6">
              <span className="text-teal-950 font-black text-xs tracking-widest uppercase drop-shadow-[0_1px_1px_rgba(255,255,255,0.4)]">
                Premium Hand-Made Carpets
              </span>
              <span className="text-teal-950 font-black text-shadow-sm drop-shadow-[0_1px_1px_rgba(255,255,255,0.4)]">
                ✦
              </span>
            </div>
          ))}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4">
            <Link
              to="/"
              className="text-2xl font-black tracking-tighter flex items-center gap-3 group mb-8 w-fit"
            >
              <motion.div
              ...
              <span
                ...
                className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-yellow-500 transition-colors duration-500 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] text-3xl"
              >
                MY
            ...
            <p className="mb-8 max-w-sm text-lg leading-relaxed text-emerald-100/70 font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
              Elevate your living space with our premium artisan collections.
              Hand-crafted carpets delivered straight to your door with
              unparalleled luxury.
            </p>
          ...
          >
            <h3 className="text-amber-400 font-black text-xl mb-8 tracking-widest uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] border-b-2 border-teal-800 pb-3 inline-block">
              Quick Links
            </h3>
            <ul className="flex flex-col gap-5">
              {["About Us", "Shop All", "FAQ", "Returns", "Shipping"].map(
                (link, idx) => (
                  <li key={idx}>
                    <Link
                      to={`/${link.toLowerCase().replace(/ & /g, "-").replace(/ /g, "-")}`}
                      className="group flex items-center font-medium hover:text-amber-400 transition-colors drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]"
                    >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-3">
            ...
            <ul className="flex flex-col gap-6">
              {[
                {
                  icon: MapPin,
                  text: "123 Artisan Ave, Suite 400\nNew York, NY 10001",
                },
                ...
                >
                  ...
                  <span className="whitespace-pre-line font-medium group-hover:text-amber-100 transition-colors mt-1 leading-snug drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
                    {item.text}
                  </span>
                </motion.li>
              ))}
        ...
        <motion.div
          ...
          className="pt-10 mt-16 border-t-2 border-teal-800 flex flex-col md:flex-row justify-between items-center gap-6 text-base font-medium relative"
        >
          ...
          <div className="flex items-center gap-3 px-6 py-3 bg-teal-900 rounded-full border-t border-l border-teal-700 border-b border-r border-black shadow-[inset_1px_1px_2px_rgba(255,255,255,0.1),_2px_4px_10px_rgba(0,0,0,0.6)]">
            <span className="text-amber-400 text-base drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
              © {new Date().getFullYear()}
            </span>
            <span className="text-white font-black tracking-widest text-base drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
              MYRUGS
            </span>
