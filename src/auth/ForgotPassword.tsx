          ...
          {!isSubmitted ? (
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="mt-6 text-center">
                <Link to="/login" className="inline-flex items-center text-sm font-bold text-amber-400 hover:text-amber-300 transition-colors drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
            ...
            >
              <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-teal-950 border-t border-l border-black border-b border-r border-teal-800 shadow-[inset_2px_2px_6px_rgba(0,0,0,0.8),_4px_4px_15px_rgba(0,0,0,0.5)] mb-6">
                <Mail className="h-8 w-8 text-amber-400 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">Check your email</h3>
