          ...
          >
            ...
            >
              <div className="px-4 py-1.5 rounded-full bg-teal-900 border-t border-l border-teal-700 border-b border-r border-black shadow-[inset_1px_1px_2px_rgba(255,255,255,0.1),_2px_4px_8px_rgba(0,0,0,0.4)] flex items-center gap-2 w-fit">
                ...
                <span className="text-emerald-100/90 text-sm font-semibold tracking-wider uppercase">Artisanal Heritage</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <span className="relative inline-block mt-2">
                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-500 to-amber-600 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Luxury Into
                </span>
            ...
            >
              Discover hand-crafted carpets that blend centuries of traditional artistry with stunning modern aesthetics. Delivered straight to your floor.
            </motion.p>
            ...
            >
              <div className="flex flex-col">
                ...
                <span className="text-emerald-100/60 text-sm mt-1 font-medium">4.9/5 from 2,000+ reviews</span>
              </div>
              <div className="w-px h-10 bg-teal-800/60" />
              <div className="flex flex-col">
                <span className="text-white font-black text-xl drop-shadow-md">Hand-Knotted</span>
                <span className="text-emerald-100/60 text-sm font-medium">Premium Quality</span>
              </div>
            </motion.div>
          </motion.div>
          ...
          <div className="relative h-[500px] lg:h-[650px] w-full perspective-1000">
            ...
            >
              <div className="w-full h-full p-2 bg-teal-950 rounded-2xl border-t border-l border-teal-800 border-b border-r border-black shadow-[0_10px_30px_rgba(0,0,0,0.6)] -rotate-6">
                <div className="w-full h-full rounded-xl overflow-hidden relative">
                  ...
                  <img 
                    src="https://images.unsplash.com/photo-1581539250439-c96689b516f2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
            ...
            >
              <div className="p-4 bg-teal-900/90 backdrop-blur-md rounded-2xl border-t-2 border-l-2 border-teal-700 border-b-2 border-r-2 border-black shadow-[0_15px_40px_rgba(0,0,0,0.6),_inset_1px_1px_2px_rgba(255,255,255,0.2)]">
                ...
                <h4 className="text-amber-400 font-bold text-sm tracking-widest uppercase mb-1 drop-shadow-sm">Authentic</h4>
                <p className="text-emerald-100/70 text-xs font-medium">Hand-woven by master artisans</p>
              </div>
            </motion.div>
