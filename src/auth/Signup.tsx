      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          ...
          <p className="mt-2 text-center text-sm text-emerald-100/60 font-medium">
            ...
            <Link
              to="/login"
              className="font-semibold text-amber-400 hover:text-amber-300 transition-colors drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]"
            >
        ...
        <div className="bg-teal-900 py-8 px-4 sm:rounded-[30px] sm:px-10 border-t-2 border-l-2 border-teal-700 border-b-2 border-r-2 border-black shadow-[4px_10px_25px_rgba(0,0,0,0.8),_inset_1px_1px_3px_rgba(255,255,255,0.1)] relative">
          <form className="space-y-6 relative" onSubmit={handleSubmit}>
            <div>
              <label
                htmlFor="name"
                className="block text-sm font-bold text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] mb-2 uppercase tracking-widest"
              >
                Full Name
              </label>
              <div className="relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
                  <User className="h-5 w-5 text-emerald-100/50" />
                </div>
                <input
                  id="name"
                  name="name"
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 py-1 bg-teal-950 rounded-full border-t border-l border-black border-b border-r border-teal-800 font-bold uppercase tracking-widest text-emerald-100/50 shadow-[inset_2px_2px_5px_rgba(0,0,0,0.6)]">
                  Or continue with
                </span>
              </div>
            </div>
