...
const products = [
  { 
    ...
    price: "$2,499", 
    tag: "Bestseller",
    image: "https://images.unsplash.com/photo-1579541595180-8798bf1c360b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
  },
  { 
    id: 2, 
  ...
  { 
    ...
    price: "$3,100", 
    tag: "Masterpiece",
    image: "https://images.unsplash.com/photo-1581539250439-c96689b516f2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
  },
  { 
    id: 4, 
    name: "Abstract Azure", 
    price: "$1,250", 
    tag: "Trending",
    image: "https://images.unsplash.com/photo-1549448981-bc54c03fe76f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
  },
  { 
    id: 5, 
    name: "Nomadic Wool", 
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl">
            ...
            <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-100 to-emerald-300 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-yellow-600">Masterpieces</span>
            </h3>
          </div>
              ...
              <div className="bg-teal-900 rounded-3xl p-3 border-t-2 border-l-2 border-teal-700 border-b-2 border-r-2 border-black shadow-[10px_15px_30px_rgba(0,0,0,0.7),_inset_1px_1px_3px_rgba(255,255,255,0.1)] h-full flex flex-col">
                ...
                <div className="px-2 flex flex-col flex-1 justify-between">
                  <div>
                    ...
                    <h4 style={{ fontFamily: "'Playfair Display', serif" }} className="text-2xl font-bold text-emerald-100 group-hover:text-amber-400 transition-colors drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] mb-1">
                      {product.name}
                    </h4>
                    <p className="text-emerald-100/60 text-sm font-medium mb-4">Hand-woven 100% Wool</p>
                  </div>
