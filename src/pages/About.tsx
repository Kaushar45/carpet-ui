        ...
        <section className="grid md:grid-cols-2 gap-12 items-center px-4 md:px-0">
          ...
          >
            ...
            <p className="text-emerald-100/80 mb-4 leading-relaxed text-lg font-medium drop-shadow-sm">
              At KALIRUGS, we believe that a rug is much more than floor covering. It is the unifying focal point of any room, dictating tone, rhythm, and character. We partner directly with artisan collectives across the world to source the highest-grade natural fibers.
            </p>
